<%@ Page Title="Employee Requested Refer Info List" Language="C#" MasterPageFile="~/SiteMaster.master"
    AutoEventWireup="true" CodeFile="RequestedReferInfoList.aspx.cs" Inherits="RequestedReferInfoList" %>
                        ...
                        <div class="form-inline">
                            <asp:GridView ID="gvRequestedRefer" runat="server" CssClass="table table-hover table-bordered table-condensed"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EmpBranchCode" HeaderText="Branch Code" ItemStyle-Width="5%" />
