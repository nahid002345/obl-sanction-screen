...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tImage = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
            ...
            '   {footer}\n' +
            '</div>\n',
            tXml = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   <img src="{data}" class="file-preview-image" title="{caption}" alt="{caption}" ' + STYLE_SETTING + '>\n' +
            '   {footer}\n' +
            '</div>\n',
        ...
        defaultPreviewTypes = ['image', 'xml', 'html', 'text', 'video', 'audio', 'flash', 'object'],
        defaultPreviewSettings = {
            image: { width: "auto", height: "160px" },
            xml: { width: "auto", height: "160px" },
        ...
        defaultFileTypeSettings = {
            ...
            xml: function (vType, vName) {
                return (vType !== undefined) ? vType.match('xml.*') : vName.match(/\.(xml)$/i);
            },
