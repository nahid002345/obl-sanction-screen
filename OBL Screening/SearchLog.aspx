<%@ Page Title="Employee Search Log List" Language="C#" MasterPageFile="~/SiteMaster.master"
    AutoEventWireup="true" CodeFile="SearchLog.aspx.cs" Inherits="SearchLog" %>
...
<asp:Content ID="chpSearch" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="glyphicon glyphicon-list-alt"></span>Search Log List
                                ...
                                <asp:TemplateField HeaderText="Detail" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        ...
                                        <%}
                                          ...
                                          { %>
                                        <a href="CTPCSearchSanctionList.aspx?<%# Eval("SearchDetail")%>&SRCHID=<%# Eval("SearchRefNo")%>"
                                            class="btn btn-success">SHOW</a>
                                            <%} --%>
