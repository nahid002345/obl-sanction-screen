<%@ Page Title="Sanction List" Language="C#" MasterPageFile="~/SiteMaster.master"
    AutoEventWireup="true" CodeFile="SearchSanctionList.aspx.cs" Inherits="SearchSanctionList" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div style="margin-bottom: 10px; width: 50%; float: left;" class="form-inline">
                                    ...
                                    <asp:DropDownList runat="server" CssClass="form-control" ID="ddlReferTo" placeholder="Select Refer To"
                                        Width="75%" />
                                    <asp:RequiredFieldValidator InitialValue="0" ID="referToVal" Display="Dynamic"
                                        ControlToValidate="ddlReferTo" runat="server" Text="*" ErrorMessage="Please Select Refer To"
                                ...
                                <div style="margin-bottom: 10px; width: 50%; float: left;" class="form-inline">
                                    ...
                                    <asp:TextBox ID="txtReferRemark" runat="server" TextMode="MultiLine"  CssClass="form-control" placeholder="Enter Refer Remarks (if any)"
                                        Enabled="true" Width="60%"></asp:TextBox>
                                </div>
                                <div style="margin-bottom: 10px; width: 50%; float: left;" class="form-inline">
                        ...
                        <asp:GridView ID="gridSanctionList" runat="server" CssClass="table table-hover table-bordered table-condensed"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="SDN_ID" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        <a href="SanctionDetails.aspx?Id=<%# Eval("SDNENTRY_ID")%> &Type=<%# Eval("LISTED_BY")%> &SType=<%# Eval("SDNTYPE")%>&SRCHID=<%=lblSearchID.Text%>">
                                            <%# Eval("NAME")%></a>
                                    </ItemTemplate>
